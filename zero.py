...
print ("====雪乃登入成功====")
sb = LINE("ENdXtxVovmSYGL0Pcsm2.Hqt3usa6GThPGq1W+eE7OG.9Dd2VZdcOZx+gw2/FWha3cHGAuHuXtpaHtXm0uchAqM=")
sb.log("Auth Token : " + str(kl.authToken))
print ("====Saber登入成功====")
kt = LINE("EN5aV0de3pmbI3gqvVl0.TQuvGUe+OXXocehvIoIIKa.cxKXKJdTl+eNKY49dZ0nJ38SEo61ULySVQDH9993+Ps=")
kt.log("Auth Token : " + str(kl.authToken))
print ("====Kirito登入成功====")
sa = LINE("ENFtbVaUMn75OPi7HvH8.+Es3tzQcdLmg7lYXW5GFIa.CFiThb5i9MKbBiwIKIdDBT0jMucfSVHM1z45tp9NFI4=")
