...
print ("====主機登入成功====")
kl = LINE("zhangceshi745@gmail.com", "qwaszx9910425")
kl.log("Auth Token : " + str(kl.authToken))
print ("====雪乃登入成功====")
sb = LINE("yuanyuan.800628@gmail.com", "qwaszx9910425")
sb.log("Auth Token : " + str(kl.authToken))
print ("====Saber登入成功====")
kt = LINE("zw006477@gmail.com", "qwaszx9910425")
kt.log("Auth Token : " + str(kl.authToken))
print ("====Kirito登入成功====")
sa = LINE("dwvs1106@gmail.com", "qwaszx9910425")
