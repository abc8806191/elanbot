...
botStart = time.time()
cl = LINE("ENNpPWKtSoC17wMF7Ppf.N7A7VYjaCUzCSJfSdFNnRW.dGG0Jmc0XFKj6SxPxuZrDMwyFqT6ZSTGBHAGHwNh5MM=")
cl.log("Auth Token : " + str(cl.authToken))
print ("====主機登入成功====")
kl = LINE("ENnK1BfoXoY5Sc7pCt28.+Es3tzQcdLmg7lYXW5GFIa.V8H69H9Hq0f4eyPWAw8yZ1PvQn2iKWtHWCZEzNVkHmM=")
kl.log("Auth Token : " + str(kl.authToken))
print ("====雪乃登入成功====")
sb = LINE("EN1ShxknljXzt4JEJyy2.Hqt3usa6GThPGq1W+eE7OG.wMHx7WIxz2jX+RrAHgeVlHsdJgRW5NNGTl9ifgp03MM=")
sb.log("Auth Token : " + str(kl.authToken))
print ("====Saber登入成功====")
kt = LINE("EN2H3QkUsShdDYCz5mOb.prRZLwJqPCmMfE5IXSxJAW.8MD1eUxBFdPTQF6IlMYOdOxQYBfz7e51y4Z5byxRRR0=")
kt.log("Auth Token : " + str(kl.authToken))
print ("====Kirito登入成功====")
sa = LINE("ENyBvH5ip5D25HmWn7de.DPb0VWc+lxIi+i5T4WVCBG.+EIRU5uFw2ekUUXYqwW+fdqaMpyl7kyaRHFe6SKFtZQ=")
